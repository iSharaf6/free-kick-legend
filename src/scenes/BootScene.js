...
import { CROWD_PANORAMA, CROWD_SETS } from '../data/crowdPanorama.js';
...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    CROWD_SETS.forEach((set) => {
      this.load.spritesheet(set.textureKey, `${base}${set.assetPath}`, {
        frameWidth: CROWD_PANORAMA.frameWidth,
        frameHeight: CROWD_PANORAMA.frameHeight
      });
    });
