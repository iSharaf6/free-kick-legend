...
| 005 | Stabilise keeper save and recovery motion | HIGH | DONE |

`001`–`005` are complete. Keeper save presentation now uses height/speed-specific authored motion and a bounded recovery hold.
